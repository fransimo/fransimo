...
pandoc README.md -s -f markdown -t html5 -c pandoc.css --metadata title="Fran Simó" --metadata subtitle="“Art is plastic thought. A swing between ideas and aesthetics.”" -o index.html --toc
